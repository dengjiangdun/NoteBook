 ...
 */
public class RevealLineaLayout extends LinearLayout implements Runnable {
    ...
    public RevealLineaLayout(Context context) {
        super(context);
        init();
    }

    public RevealLineaLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public RevealLineaLayout(Context context, AttributeSet attrs, int defStyleAttr) {
