...
import com.johndon.cmcc.zhuomian.adapter.NoteAdapter;
import com.johndon.cmcc.zhuomian.model.Note;
import com.johndon.cmcc.zhuomian.service.NoteService;
...
public class HomeActivity extends GnBaseActivity implements NoteAdapter.LongClickListener{
    ...
    private final static String[] operation = new String[]{"删除","编辑","分享"};
    ...
    private static final String APP_ID = "300011847471";
    private static final String APP_KEY = "FFB2BE445A4D8CD8151C7959B477D8AF";
    @Override
    ...
    protected void initView() {
        ...
        mIvDeleteAllNotes.setImageDrawable(getResources().getDrawable(R.drawable.add_note_icon));
        ...
        mIvMode.setVisibility(View.GONE);
    }
